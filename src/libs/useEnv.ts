class UseEnv {
  ...
  constructor() {
    if(import.meta.env.DEV){
      this.BASE_URL =  `//${window.location.host}/server/api/artlab` //http://192.168.80.1:5173/plus-api` // "http://192.168.80.1:5173/plus-api";
      this.SOCKET_URL =  "ws://61.146.45.234:3302/api/connectWebSocket"
    } else {
      this.BASE_URL = `//${window.location.host}/api/artlab`; //"http://192.168.12.80:8888/api" //"http://itao-tech.com:8888/api" //"http://61.146.45.234:3302/api";
